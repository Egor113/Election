...
Action()
{
	...
	lr_end_transaction("UC01_TR03_Region",2);
	...
	lr_end_transaction("UC01_TR04_Subregion",2);
	...
	lr_end_transaction("UC01_TR05_Region_website",2);
	...
	for (uik_index=1; uik_index <= atoi(lr_eval_string("{UIK_IDs_count}")); uik_index++) {
		...
		lr_end_transaction("UC01_TR06_Choose_UIK",2);
		...
		lr_end_transaction("UC01_TR08_Download_results",2);
